...
export async function addUser({city,email,firstname,lastname,password,phone,street,username,zipcode}:formdata) {
    console.log({city,email,firstname,lastname,password,phone,street,username,zipcode})
